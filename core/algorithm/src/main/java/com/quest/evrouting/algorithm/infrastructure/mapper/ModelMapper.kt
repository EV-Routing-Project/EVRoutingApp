package com.quest.evrouting.algorithm.infrastructure.mapper

import com.quest.evrouting.libservice.geometry.domain.model.Geometry as ExternalGeometry
import com.quest.evrouting.libservice.geometry.domain.model.Point as ExternalPoint
import com.quest.evrouting.libservice.geometry.domain.model.LineString as ExternalLineString
import com.quest.evrouting.libservice.geometry.domain.model.Geohash as ExternalGeohash

import com.quest.evrouting.algorithm.domain.model.Geometry as DomainGeometry
import com.quest.evrouting.algorithm.domain.model.Point as DomainPoint
import com.quest.evrouting.algorithm.domain.model.LineString as DomainLineString
import com.quest.evrouting.algorithm.domain.model.Geohash as DomainGeohash
